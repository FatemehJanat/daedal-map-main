...
def render_site_llms_txt(*, app_origin: str = "https://app.daedalmap.com", site_origin: str = "https://daedalmap.com") -> str:
    return (
        ...
        f"- [{site_origin}/feeds]({site_origin}/feeds) - live collector status surface under Ops\n"
...
def render_site_llms_full(*, app_origin: str = "https://app.daedalmap.com", site_origin: str = "https://daedalmap.com") -> str:
    return (
        ...
        "DaedalMap Geographic Data - Hosted MCP and agent-ready geographic data for\n"
        f"disasters, FX, and location-linked datasets. Includes free {free_pack_display_csv()} lanes,\n"
        f"x402-paid {paid_pack_display_csv()} lanes, and an always-current pack index\n"
        f"at {site_origin}/docs/for-agents.\n\n"
        ...
        "Country ids and hierarchical geography are common, but tsunami examples may also use ocean-region ids such as `XOO`.\n\n"
        "## Human-facing pages\n\n"
        ...
        f"- [{site_origin}/feeds]({site_origin}/feeds) - Status surface listing every active live collector with its source agency, cadence, and matching pack link. Auto-generated from `live/cloud/collectors/`.\n"
